...
"""
Generate metrics plots for all benchmark runs using the ORIGINAL metrics_plots.py functions
This script uses Python 3.12 to support match statements and imports the actual functions
without any modifications to ensure data accuracy and consistency.
"""
...
try:
    # Import the ORIGINAL functions from metrics_plots.py
    from haura_plots.metrics_plots import plot_throughput, plot_tier_usage, plot_system
    from haura_plots import util
    print("✅ Successfully imported original metrics_plots functions!")
    ...
    print("Required: python3.12 generate_metrics_plots_original.py")
    sys.exit(1)

class MetricsPlotGenerator:
    """Generate metrics plots for all benchmark runs using ORIGINAL functions"""
    ...
    def load_metrics_data(self, folder_path: Path) -> Optional[List[Dict[str, Any]]]:
        """Load and parse betree-metrics.jsonl data using original util.read_jsonl"""
        ...
        try:
            with open(metrics_file, 'r', encoding="UTF-8") as f:
                # Use the ORIGINAL util.read_jsonl function
    ...
    def generate_plots_for_run(self, run_folder: Path, overwrite: bool = False) -> bool:
        """Generate all plots for a single benchmark run using ORIGINAL functions"""
        ...
        try:
            # Generate throughput plots using ORIGINAL plot_throughput function
            ...
            # Generate tier usage plot using ORIGINAL plot_tier_usage function
            ...
            # Generate system plot using ORIGINAL plot_system function
            ...
            if overwrite or not existing_plots.get('proc.svg', False):
                ...
                if out_jsonl.exists():
                    ...
                    # Use ORIGINAL plot_system function
    ...
    def generate_all_plots(self, overwrite: bool = False) -> None:
        ...
        self.log("🚀 Starting metrics plot generation using ORIGINAL functions...")
    ...
    def print_summary(self):
        ...
        if self.stats['plots_generated'] > 0:
            print("✅ Plot generation completed using ORIGINAL functions!")
            ...
            print("\n🎯 Data accuracy guaranteed - using original metrics_plots.py functions!")
        else:
            print("⚠️  No plots were generated.")

def main():
    parser = argparse.ArgumentParser(
        description='Generate metrics plots using ORIGINAL metrics_plots.py functions',
...
Note: This script requires Python 3.12+ and uses the original metrics_plots.py 
functions without any modifications to ensure data accuracy.
        """
    )
    ...
    if not args.results_dirs:
        default_dirs = [
            '/home/skarim/Code/smash/haura/betree/haura-benchmarks/results/2025-07-26_default',
            '/home/skarim/Code/smash/haura/betree/haura-benchmarks/results/2025-07-27_default'
        ]
