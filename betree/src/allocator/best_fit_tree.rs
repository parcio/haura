...
mod tests {
    ...
    fn build_empty() {
        ...
        let allocator = BestFitTree::new(bitmap);
    ...
    fn build_simple() {
        ...
        let mut allocator = BestFitTree::new([0u8; SEGMENT_SIZE_BYTES]);
        ...
        let mut allocator = BestFitTree::new(bitmap.into_inner());
    ...
    fn build_complex() {
        ...
        let allocator = BestFitTree::new(bitmap.into_inner());
    ...
    fn allocate_empty_fsm_tree() {
        let bitmap = [0u8; SEGMENT_SIZE_BYTES];
        let mut allocator = BestFitTree::new(bitmap);
